                ...
                <div className={"w-full h-full flex md:flex-col gap-8"}>
                    <div className={"w-full h-full flex flex-col gap-2"}>
                        ...
                        <p className={"text-sm text-black/50"}>
                            Evcil dostlarınızın sağlığı için sizin yanınızdayız. Profesyonel ekibimiz ve modern ekipmanlarımızla, güvenli ve sevgi dolu bir ortamda en iyi veteriner hizmetini sunuyoruz. Bize her zaman ulaşabilirsiniz!
                        </p>
